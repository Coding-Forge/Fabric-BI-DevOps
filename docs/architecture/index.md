...
This section contains architecture diagrams used throughout the Enterprise BI DevOps with Microsoft Fabric Workshop.
...
Select a diagram from the list below:

- [fabric-git-integration.md](fabric-git-integration.md)
