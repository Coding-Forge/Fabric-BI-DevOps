...
---
title: "Enterprise BI DevOps with Microsoft Fabric Workshop — Plan & Materials"
...
# Enterprise BI DevOps with Microsoft Fabric Workshop  
...
See the [Branching Strategy architecture doc](../../architecture/branching-strategy.md) for the full workflow, topology diagrams, and anti-patterns.
...
For a tool-focused extension that teaches participants how to create rules, policies, pipeline profiles, PR evidence, release readiness outputs, and governance artifacts, see the [Fabric BI DevOps Accelerator Toolkit Workshop](../accelerator-toolkit/README.md).
