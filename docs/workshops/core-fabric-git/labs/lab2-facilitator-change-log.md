...
- `docs/workshops/core-fabric-git/labs/lab2-ci-pipeline.md`
- `presentations/06-lab2-ci-pipeline.md`
- `docs/workshops/core-fabric-git/README.md`
- `Supporting_Docs_For_Workshop.md`
- `README.md`
- `docs/workshops/core-fabric-git/labs/lab1-connect-git.md`
